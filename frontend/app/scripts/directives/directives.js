(function() {
    ...
    .directive('uiLinhabar', ['$rootScope', '$anchorScroll', function($rootScope, $anchorScroll) {
        return {
            restrict: 'AC',
    ...
    .directive("hasRoles", ["AuthService", function(AuthService) {
        return {
            restrict: "A",
    ...
    .directive("isLogged", ["AuthService", function(AuthService) {
        return {
            restrict: "A",
            link: function(scope, element, attributes) {
    ...
    .directive("confirmButton", function($timeout) {
        return {
            restrict: 'A',
            scope: {
    ...
    .directive('validationMsg', ['ValidationService', function(ValidationService) {
        return {
            restrict: 'E',
            scope: {
                propriedade: '@'
    ...
    .directive("maxLength", ['$compile', 'AlertService', function($compile, AlertService) {
        return {
            restrict: 'A',
            require: 'ngModel',
    ...
    .directive("hasRolesDisable", ["AuthService", function(AuthService) {
        return {
            restrict: "A",
            link: function(scope, element, attributes) {
